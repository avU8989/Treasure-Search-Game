...
public class ClientNetworkRequest {
	...
	// args[0] in the client = gameMode if args[0] only Client UI must be run
	// args[1] server url, will hold the server url the client should use
	// args[2] gameId, hiolds the gameId
