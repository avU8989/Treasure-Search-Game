...
import gamestatechange.GameStateVisualisation;
...
public class MainClient {
	...
	public static void main(String[] args) {
		...
		if (args.length == 3) {
			...
			GameStateVisualisation visualiser = new GameStateVisualisation(game, gameLogic);
			...
			generator.getMap().get(new Position(0, 3)).setTerrain(TerrainType.WATER);
			generator.getMap().get(new Position(0, 4)).setTerrain(TerrainType.WATER);
		...
		// schatz auf deiner kartenhälfte
		// zielcastle auf gegnerischer hälfte
		/*
